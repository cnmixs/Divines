...
pub mod jingjue {
    ...
    impl JingJueCalc {
        ...
        /// 计算流年荆诀
        pub fn calc(&self, birth: &divines_core::chart::BirthInfo, query_year: i32) -> JingJueResult {
...
pub mod acg {
    ...
    impl AcgCalc {
        ...
        /// 计算ACG线
        pub fn calc_lines(&self, birth: &divines_core::chart::BirthInfo) -> Vec<AcgLine> {
            // 计算每个行星在地球上的ACG线
