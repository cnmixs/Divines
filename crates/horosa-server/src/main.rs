...
/// 应用状态
pub struct AppState {
    pub astrology: horosa_calc::astrology::AstrologyCalc,
    pub bazi: horosa_calc::bazi::BaziCalc,
    pub ziwei: horosa_calc::ziwei::ZiWeiCalc,
    pub qimen: horosa_calc::sanshi::QimenCalc,
    pub taiyi: horosa_calc::sanshi::TaiyiCalc,
    pub liuren: horosa_calc::sanshi::LiurenCalc,
    pub gua: horosa_calc::gua::GuaCalc,
    pub liuren_full: horosa_calc::liureng::LiuRengCalc,
    pub jieqi: horosa_calc::jieqi::JieQiCalc,
    pub sxwnl: horosa_calc::Sxwnl,
    pub qizheng: horosa_calc::qizheng::QizhengCalc,
    pub liuyao: horosa_calc::liuyao::LiuyaoCalc,
    pub vedic: horosa_calc::vedic::VedicCalc,
    pub predict: horosa_calc::predict::PredictCalc,
    pub fengshui: horosa_calc::remaining::fengshui::FengShuiCalc,
    pub huangji: horosa_calc::remaining::huangji::HuangJiCalc,
    pub modern: horosa_calc::remaining::modern::ModernCalc,
    pub acg: horosa_calc::remaining::acg::AcgCalc,
    pub jingjue: horosa_calc::remaining::jingjue::JingJueCalc,
    pub shenyishu: horosa_calc::remaining::shenyishu::ShenYiShuCalc,
    pub jinkou: horosa_calc::remaining::jinkou::JinKouCalc,
    pub wuzhao: horosa_calc::remaining::wuzhao::WuZhaoCalc,
    pub taixuan: horosa_calc::remaining::taixuan::TaiXuanCalc,
    pub beiji: horosa_calc::remaining::beiji::BeiJiCalc,
    pub cetian: horosa_calc::remaining::cetian::CeTianCalc,
    pub chunzi: horosa_calc::remaining::chunzi::ChunZiCalc,
    pub fendjing: horosa_calc::remaining::fendjing::FenJingCalc,
    pub nanji: horosa_calc::remaining::nanji::NanJiCalc,
    pub shaozi: horosa_calc::remaining::shaozi::ShaoZiCalc,
    pub tieban: horosa_calc::remaining::tieban::TieBanCalc,
    pub xianqin: horosa_calc::remaining::xianqin::XianQinCalc,
    pub planetarium: horosa_calc::remaining::planetarium::PlanetariumCalc,
    pub germany: horosa_calc::remaining::germany::GermanyCalc,
}

impl AppState {
    pub fn new() -> Self {
        Self {
            astrology: horosa_calc::astrology::AstrologyCalc::default(),
            bazi: horosa_calc::bazi::BaziCalc::default(),
            ziwei: horosa_calc::ziwei::ZiWeiCalc::default(),
            qimen: horosa_calc::sanshi::QimenCalc::default(),
            taiyi: horosa_calc::sanshi::TaiyiCalc::default(),
            liuren: horosa_calc::sanshi::LiurenCalc::default(),
            gua: horosa_calc::gua::GuaCalc::default(),
            liuren_full: horosa_calc::liureng::LiuRengCalc::default(),
            jieqi: horosa_calc::jieqi::JieQiCalc::default(),
            sxwnl: horosa_calc::Sxwnl::default(),
            qizheng: horosa_calc::qizheng::QizhengCalc::default(),
            liuyao: horosa_calc::liuyao::LiuyaoCalc::new(),
            vedic: horosa_calc::vedic::VedicCalc::new(),
            predict: horosa_calc::predict::PredictCalc::new(),
            fengshui: horosa_calc::remaining::fengshui::FengShuiCalc::new(),
            huangji: horosa_calc::remaining::huangji::HuangJiCalc::new(),
            modern: horosa_calc::remaining::modern::ModernCalc::new(),
            acg: horosa_calc::remaining::acg::AcgCalc::new(),
            jingjue: horosa_calc::remaining::jingjue::JingJueCalc::new(),
            shenyishu: horosa_calc::remaining::shenyishu::ShenYiShuCalc::new(),
            jinkou: horosa_calc::remaining::jinkou::JinKouCalc::new(),
            wuzhao: horosa_calc::remaining::wuzhao::WuZhaoCalc::new(),
            taixuan: horosa_calc::remaining::taixuan::TaiXuanCalc::new(),
            beiji: horosa_calc::remaining::beiji::BeiJiCalc::new(),
            cetian: horosa_calc::remaining::cetian::CeTianCalc::new(),
            chunzi: horosa_calc::remaining::chunzi::ChunZiCalc::new(),
            fendjing: horosa_calc::remaining::fendjing::FenJingCalc::new(),
            nanji: horosa_calc::remaining::nanji::NanJiCalc::new(),
            shaozi: horosa_calc::remaining::shaozi::ShaoZiCalc::new(),
            tieban: horosa_calc::remaining::tieban::TieBanCalc::new(),
            xianqin: horosa_calc::remaining::xianqin::XianQinCalc::new(),
            planetarium: horosa_calc::remaining::planetarium::PlanetariumCalc::new(),
            germany: horosa_calc::remaining::germany::GermanyCalc::new(),
        }
    }
}
...
async fn main() -> anyhow::Result<()> {
    ...
    tracing_subscriber::registry()
        .with(tracing_subscriber::EnvFilter::try_from_default_env()
            .unwrap_or_else(|_| "horosa_server=info,tower_http=info".into()))
        .with(tracing_subscriber::fmt::layer())
        .init();

    tracing::info!("星阙 Horosa 服务器启动中...");
