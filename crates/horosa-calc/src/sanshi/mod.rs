...
/// 奇门遁甲常量数据
mod constants {
    use horosa_core::sanshi::{DunType, GongInfo};
    /// 十天干
...
impl QimenCalc {
    ...
    pub fn calculate(&self, year: i32, month: u32, day: u32, hour: u32, minute: u32) -> QimenChart {
        ...
        QimenChart {
            ...
            xun_kong,
            ma_xing,
            shi_chen: horosa_core::sanshi::DiZhi::from_str(shi_chen.name_zh()).unwrap_or(horosa_core::sanshi::DiZhi::Zi),
