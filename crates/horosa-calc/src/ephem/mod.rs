// 星阙 Horosa - Swiss Ephemeris FFI 绑定
...
impl Ephemeris {
    /// 初始化星历表
    pub fn new(ephe_path: Option<&str>) -> HorosaResult<Self> {
    ...
    pub fn calc_houses(
        ...
        latitude: f64,
        longitude: f64,
    ) -> HorosaResult<(Vec<House>, Ascendant, Midheaven)> {
    ...
    /// 计算恒星时
    pub fn calc_sidereal_time(&self, julian_day: f64) -> HorosaResult<f64> {
    ...
    pub fn calc_asc_mc(
        ...
        latitude: f64,
        longitude: f64,
    ) -> HorosaResult<(Ascendant, Midheaven)> {
